...
function App() {
  ...
  const comparison = useMemo(() => runComparison(household), [household]);
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      <main className="mx-auto max-w-6xl px-4 pb-16 pt-8 sm:px-6">
        ...
        >
          <HabitComparisonCard low={comparison.low} monthly={comparison.monthly} monthCount={comparison.months.length} />
        </SectionCard>
